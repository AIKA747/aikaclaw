...
export function listWhatsAppAuthDirs(cfg: AikaClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AikaClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AikaClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AikaClawConfig): ResolvedWhatsAppAccount[] {
