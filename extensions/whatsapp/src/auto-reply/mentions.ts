import { buildMentionRegexes, normalizeMentionText } from "aikaclaw/plugin-sdk/channel-inbound";
import type { loadConfig } from "aikaclaw/plugin-sdk/config-runtime";
import { isSelfChatMode, jidToE164, normalizeE164 } from "aikaclaw/plugin-sdk/text-runtime";
