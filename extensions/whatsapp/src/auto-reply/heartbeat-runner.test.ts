...
vi.mock("aikaclaw/plugin-sdk/agent-runtime", () => ({
...
vi.mock("../auth-store.js", () => ({
  WA_WEB_AUTH_DIR: "/tmp/aikaclaw-oauth/whatsapp/default",
  resolveDefaultWebAuthDir: () => "/tmp/aikaclaw-oauth/whatsapp/default",
