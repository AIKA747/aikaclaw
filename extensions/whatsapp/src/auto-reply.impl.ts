export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "aikaclaw/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "aikaclaw/plugin-sdk/reply-runtime";
