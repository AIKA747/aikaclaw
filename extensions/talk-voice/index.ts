import { resolveActiveTalkProviderConfig } from "aikaclaw/plugin-sdk/config-runtime";
import type { SpeechVoiceOption } from "aikaclaw/plugin-sdk/speech";
import { definePluginEntry, type AikaClawPluginApi } from "./api.js";
