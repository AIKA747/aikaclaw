...
import { resolveAgentDir } from "aikaclaw/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "aikaclaw/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "aikaclaw/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "aikaclaw/plugin-sdk/config-runtime";
import { formatErrorMessage } from "aikaclaw/plugin-sdk/infra-runtime";
import { resolvePreferredAikaClawTmpDir } from "aikaclaw/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "aikaclaw/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "aikaclaw/plugin-sdk/speech";
import { textToSpeech } from "aikaclaw/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: AikaClawConfig; override?: TtsConfig }): {
  cfg: AikaClawConfig;
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredAikaClawTmpDir(), "discord-voice-"));
