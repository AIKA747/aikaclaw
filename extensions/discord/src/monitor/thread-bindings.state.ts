...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "aikaclaw/plugin-sdk/routing";
import { resolveStateDir } from "aikaclaw/plugin-sdk/state-paths";
import { resolveGlobalSingleton } from "aikaclaw/plugin-sdk/text-runtime";
import {
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("aikaclaw.discordThreadBindingsState");
