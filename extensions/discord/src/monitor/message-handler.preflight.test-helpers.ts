...
export type DiscordConfig = NonNullable<AikaClawConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("aikaclaw/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "aikaclaw-bot",
