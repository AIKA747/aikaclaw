...
import { formatDurationSeconds } from "aikaclaw/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("aikaclaw/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("aikaclaw/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("aikaclaw/plugin-sdk/runtime-env").createSubsystemLogger>;
