...
import type { SessionBindingRecord } from "aikaclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "aikaclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "aikaclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("aikaclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("aikaclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("aikaclaw/plugin-sdk/config-runtime").AikaClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
