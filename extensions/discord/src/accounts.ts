...
import { normalizeAccountId } from "aikaclaw/plugin-sdk/account-id";
import { resolveAccountEntry } from "aikaclaw/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, AikaClawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: AikaClawConfig): ResolvedDiscordAccount[] {
