...
vi.mock("aikaclaw/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("aikaclaw/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("aikaclaw/plugin-sdk/web-media"));
