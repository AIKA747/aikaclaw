...
import { maxBytesForKind } from "aikaclaw/plugin-sdk/media-runtime";
import { extensionForMime } from "aikaclaw/plugin-sdk/media-runtime";
import { unlinkIfExists } from "aikaclaw/plugin-sdk/media-runtime";
import type { PollInput } from "aikaclaw/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "aikaclaw/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredAikaClawTmpDir();
