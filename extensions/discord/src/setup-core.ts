import { DEFAULT_ACCOUNT_ID } from "aikaclaw/plugin-sdk/account-id";
import type { DiscordGuildEntry } from "aikaclaw/plugin-sdk/config-runtime";
import type { AikaClawConfig } from "aikaclaw/plugin-sdk/config-runtime";
import { createEnvPatchedAccountSetupAdapter } from "aikaclaw/plugin-sdk/setup-adapter-runtime";
import type {
  ChannelSetupAdapter,
