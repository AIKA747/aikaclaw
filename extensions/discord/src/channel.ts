...
function hasDiscordExecApprovalDmRoute(cfg: AikaClawConfig): boolean {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). AikaClaw adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
