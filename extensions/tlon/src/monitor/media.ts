...
import { fetchWithSsrFGuard } from "aikaclaw/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to AikaClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".aikaclaw", "workspace", "media", "inbound");
 ...
 * Format matches AikaClaw's expected attachment structure.
 */
