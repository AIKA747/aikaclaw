import { OPENCODE_GO_DEFAULT_MODEL_REF } from "aikaclaw/plugin-sdk/provider-models";
import {
...
export function applyOpencodeGoProviderConfig(cfg: AikaClawConfig): AikaClawConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeGoConfig(cfg: AikaClawConfig): AikaClawConfig {
