...
function mergeZalouserAccountConfig(cfg: AikaClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: AikaClawConfig; accountId?: string | null }) {
