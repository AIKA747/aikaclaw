...
import type { AikaClawConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: AikaClawConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: AikaClawConfig; accountId: string }): Promise<{
