import type { ChannelSetupAdapter, AikaClawConfig } from "aikaclaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: AikaClawConfig, accountId: string): boolean {
