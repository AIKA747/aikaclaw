...
function mergeSignalAccountConfig(cfg: AikaClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AikaClawConfig): ResolvedSignalAccount[] {
