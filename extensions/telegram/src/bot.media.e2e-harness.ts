...
import type { GetReplyOptions, MsgContext } from "aikaclaw/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("aikaclaw/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as AikaClawConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("aikaclaw/plugin-sdk/media-runtime")>,
) {
...
vi.mock("aikaclaw/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("aikaclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("aikaclaw/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
