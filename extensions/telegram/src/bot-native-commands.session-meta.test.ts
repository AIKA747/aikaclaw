...
type ResolveConfiguredBindingRouteFn =
  typeof import("aikaclaw/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
...
vi.mock("aikaclaw/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/aikaclaw-sessions.json");
