import type { createChannelPairingChallengeIssuer } from "aikaclaw/plugin-sdk/channel-pairing";
...
vi.mock("aikaclaw/plugin-sdk/channel-pairing", () => ({
  createChannelPairingChallengeIssuer: createChannelPairingChallengeIssuerMock,
}));

vi.mock("aikaclaw/plugin-sdk/conversation-runtime", () => ({
