...
function resolveAccount(cfg: AikaClawConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: AikaClawConfig, accountId: string) {
...
function startTelegramAccount(cfg: AikaClawConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: AikaClawConfig) {
