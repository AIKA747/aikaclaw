...
import { clearHistoryEntriesIfEnabled } from "aikaclaw/plugin-sdk/reply-history";
...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "aikaclaw/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: AikaClawConfig, agentId: string) {
  try {
