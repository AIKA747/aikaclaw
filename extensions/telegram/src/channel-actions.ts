...
} from "aikaclaw/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "aikaclaw/plugin-sdk/config-runtime";
import { extractToolSend } from "aikaclaw/plugin-sdk/tool-send";
import {
