...
import { createFinalizableDraftLifecycle } from "aikaclaw/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("aikaclaw.telegramDraftStreamState");
