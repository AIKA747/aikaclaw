...
import type { ChannelGroupPolicy } from "aikaclaw/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "aikaclaw/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("aikaclaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("aikaclaw/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("aikaclaw/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("aikaclaw/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("aikaclaw/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("aikaclaw/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("aikaclaw/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as AikaClawConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as AikaClawConfig),
