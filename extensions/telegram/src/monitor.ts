...
import { resolveAgentMaxConcurrent } from "aikaclaw/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "aikaclaw/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: AikaClawConfig): RunOptions<unknown> {
  return {
    sink: {
