import { createScopedExpiringIdCache, resolveGlobalMap } from "aikaclaw/plugin-sdk/text-runtime";
 ...
 */
const TELEGRAM_SENT_MESSAGES_KEY = Symbol.for("aikaclaw.telegramSentMessages");
