...
vi.mock("aikaclaw/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/aikaclaw-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.AIKACLAW_STATE_DIR = "/tmp/aikaclaw-test-sticker-cache";
    fs.rmSync("/tmp/aikaclaw-test-sticker-cache", { recursive: true, force: true });
