...
import type { TelegramExecApprovalConfig } from "aikaclaw/plugin-sdk/config-runtime";
import { getExecApprovalReplyMetadata } from "aikaclaw/plugin-sdk/infra-runtime";
