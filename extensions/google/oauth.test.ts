...
describe("loginGeminiCliOAuth", () => {
  ...
  beforeEach(() => {
    ...
    process.env.AIKACLAW_GEMINI_OAUTH_CLIENT_ID = "test-client-id.apps.googleusercontent.com";
    process.env.AIKACLAW_GEMINI_OAUTH_CLIENT_SECRET = "GOCSPX-test-client-secret"; // pragma: allowlist secret
