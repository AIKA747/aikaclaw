...
function resolveAikaClawVersion(): string {
  try {
 ...
 * and appends the AikaClaw version.
 *
 * Format: "teams.ts[apps]/<sdk-version> AikaClaw/<aikaclaw-version>"
 * Example: "teams.ts[apps]/2.0.5 AikaClaw/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} AikaClaw/${resolveAikaClawVersion()}`;
  return cachedUserAgent;
}
