...
import { normalizeSecretInput } from "aikaclaw/plugin-sdk/provider-auth";
...
type WebFetchConfig = NonNullable<AikaClawConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: AikaClawConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: AikaClawConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: AikaClawConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: AikaClawConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: AikaClawConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlOnlyMainContent(cfg?: AikaClawConfig, override?: boolean): boolean {
...
export function resolveFirecrawlMaxAgeMs(cfg?: AikaClawConfig, override?: number): number {
