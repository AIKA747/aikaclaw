...
import { jsonResult, readNumberParam, readStringParam } from "aikaclaw/plugin-sdk/agent-runtime";
...
export function createFirecrawlScrapeTool(api: AikaClawPluginApi) {
  return {
