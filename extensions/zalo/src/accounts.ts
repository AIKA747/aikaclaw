...
function mergeZaloAccountConfig(cfg: AikaClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AikaClawConfig): ResolvedZaloAccount[] {
