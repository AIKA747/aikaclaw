import { createActionGate } from "aikaclaw/plugin-sdk/agent-runtime";
import type { ChannelMessageActionName } from "aikaclaw/plugin-sdk/channel-contract";
import type { AikaClawConfig } from "aikaclaw/plugin-sdk/config-runtime";
import type { ChannelToolSend } from "aikaclaw/plugin-sdk/tool-send";
import { listEnabledSlackAccounts } from "./accounts.js";

export function listSlackMessageActions(cfg: AikaClawConfig): ChannelMessageActionName[] {
