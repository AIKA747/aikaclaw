import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "aikaclaw/plugin-sdk/config-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "aikaclaw/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("aikaclaw/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("aikaclaw/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("aikaclaw/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("aikaclaw/plugin-sdk/conversation-runtime").resolveConversationLabel;
...
type ResolveMarkdownTableMode =
  typeof import("aikaclaw/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("aikaclaw/plugin-sdk/routing").resolveAgentRoute;
