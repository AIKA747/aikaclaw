...
import { resolveSessionKey, type SessionScope } from "aikaclaw/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "aikaclaw/plugin-sdk/config-runtime";
import { createDedupeCache } from "aikaclaw/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("aikaclaw/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
