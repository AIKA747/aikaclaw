...
import { type ChatCommandDefinition, type CommandArgs } from "aikaclaw/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "aikaclaw/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "aikaclaw_cmdarg";
