...
import { resolveMergedAccountConfig } from "aikaclaw/plugin-sdk/account-resolution";
import { createAccountListHelpers, type AikaClawConfig } from "../runtime-api.js";
...
export function listEnabledMattermostAccounts(cfg: AikaClawConfig): ResolvedMattermostAccount[] {
