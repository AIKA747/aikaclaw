...
function resolveBlueBubblesServerUrl(cfg: AikaClawConfig, accountId: string): string | undefined {
  return resolveBlueBubblesAccount({ cfg, accountId }).config.serverUrl?.trim() || undefined;
}

function resolveBlueBubblesWebhookPath(cfg: AikaClawConfig, accountId: string): string | undefined {
...
export const blueBubblesSetupWizard: ChannelSetupWizard = {
  ...
  completionNote: {
    ...
    lines: [
      ...
      "2. Add your AikaClaw gateway URL + webhook path",
