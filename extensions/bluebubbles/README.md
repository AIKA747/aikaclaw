...
This directory contains the **BlueBubbles external channel plugin** for AikaClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `aikaclaw/plugin-sdk` helpers.
