import { definePluginEntry, type AikaClawConfig, type AikaClawPluginApi } from "./api.js";
...
function resolveOwnershipAgent(config: AikaClawConfig): { id: string; name: string } {
