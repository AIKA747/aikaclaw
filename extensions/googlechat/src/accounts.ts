...
import { isSecretRef, type AikaClawConfig } from "aikaclaw/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: AikaClawConfig): ResolvedGoogleChatAccount[] {
