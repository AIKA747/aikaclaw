...
import { createChannelPairingChallengeIssuer } from "aikaclaw/plugin-sdk/channel-pairing";
...
import { normalizeScpRemoteHost } from "aikaclaw/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "aikaclaw/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "aikaclaw/plugin-sdk/media-runtime";
...
import { danger, logVerbose, shouldLogVerbose, warn } from "aikaclaw/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "aikaclaw/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T aikaclaw@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., aikaclaw@192.168.64.3)
