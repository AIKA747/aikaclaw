...
function mergeIMessageAccountConfig(cfg: AikaClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AikaClawConfig): ResolvedIMessageAccount[] {
