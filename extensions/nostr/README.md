...
Nostr DM channel plugin for AikaClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AikaClaw. It enables your bot to:
...
# Configure aikaclaw to use local relay
