...
function resolveConfiguredDefaultNostrAccountId(cfg: AikaClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: AikaClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: AikaClawConfig): string {
