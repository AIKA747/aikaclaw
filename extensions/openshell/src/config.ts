...
import type { AikaClawPluginConfigSchema } from "aikaclaw/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): AikaClawPluginConfigSchema {
