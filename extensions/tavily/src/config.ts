...
export function resolveTavilySearchConfig(cfg?: AikaClawConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: AikaClawConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: AikaClawConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
