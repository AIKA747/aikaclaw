...
vi.mock("aikaclaw/plugin-sdk/provider-models", () => ({
...
vi.mock("aikaclaw/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("aikaclaw/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/aikaclaw-state",
}));

import type { ProviderResolveDynamicModelContext } from "aikaclaw/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/aikaclaw-state/credentials/github-copilot.token.json";
