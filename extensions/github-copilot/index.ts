import { ensureAuthProfileStore, listProfilesForProvider } from "aikaclaw/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "aikaclaw/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "aikaclaw/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "aikaclaw/plugin-sdk/provider-auth-login";
