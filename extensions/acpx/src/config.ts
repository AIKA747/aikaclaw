...
import type { AikaClawPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "aikaclaw.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): AikaClawPluginConfigSchema {
  return {
