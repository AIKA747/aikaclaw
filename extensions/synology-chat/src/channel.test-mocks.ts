...
vi.mock("aikaclaw/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("aikaclaw/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("aikaclaw/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("aikaclaw/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("aikaclaw/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("aikaclaw/plugin-sdk/webhook-ingress");
  return {
    ...actual,
