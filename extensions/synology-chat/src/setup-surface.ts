...
function getRawAccountConfig(cfg: AikaClawConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: AikaClawConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: AikaClawConfig, accountId: string): string[] {
  ...
  textInputs: [
    {
      ...
      helpLines: [
        ...
        "This is the URL AikaClaw uses to send replies back to Chat.",
      ],
