...
import { resolveDangerousNameMatchingEnabled } from "aikaclaw/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full AikaClaw config object. */
function getChannelConfig(cfg: AikaClawConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: AikaClawConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.AIKACLAW_BOT_NAME ?? "AikaClaw";
