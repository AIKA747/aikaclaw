...
async function createConversationRuntimeMock(
  importOriginal: () => Promise<typeof import("aikaclaw/plugin-sdk/conversation-runtime")>,
) {
...
vi.mock("aikaclaw/plugin-sdk/security-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("aikaclaw/plugin-sdk/security-runtime")>();
  return {
    ...actual,
...
vi.mock("aikaclaw/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("aikaclaw/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
...
export function resetDiscordComponentRuntimeMocks() {
  ...
  resolvePluginConversationBindingApprovalMock.mockReset().mockResolvedValue({
    ...
    binding: {
      ...
      pluginName: "AikaClaw App Server",
