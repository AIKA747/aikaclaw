import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "aikaclaw/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "aikaclaw/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "aikaclaw/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/aikaclaw"),
    },
    modelAuth: {
