...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.aikaclaw/aikaclaw.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde aikaclaw dashboard --no-open en tu escritorio.",
    },
    insecure: {
