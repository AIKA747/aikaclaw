    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="AikaClaw" />
          <div class="login-gate__title">AikaClaw</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="AIKACLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
