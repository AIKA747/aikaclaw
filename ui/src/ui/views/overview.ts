...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">aikaclaw devices list</span><br />
          <span class="mono">aikaclaw devices approve &lt;requestId&gt;</span>
        </div>
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.aikaclaw.ai/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">aikaclaw dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">aikaclaw doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "aikaclaw dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.aikaclaw.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.aikaclaw.ai/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.aikaclaw.ai/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px;">
                    <input
                      ...
                      placeholder="AIKACLAW_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
            ...
            ? html`
                <div class="login-gate__help" style="margin-top: 16px;">
                  ...
                  <ol class="login-gate__steps">
                    <li>${t("overview.connection.step1")}<code>aikaclaw gateway run</code></li>
                    <li>${t("overview.connection.step2")}<code>aikaclaw dashboard --no-open</code></li>
                    <li>${t("overview.connection.step3")}</li>
                    <li>${t("overview.connection.step4")}<code>aikaclaw doctor --generate-gateway-token</code></li>
                  </ol>
