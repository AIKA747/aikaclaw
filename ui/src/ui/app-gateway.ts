...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "aikaclaw-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void subscribeSessions(host as unknown as AikaClawApp);
      void loadAssistantIdentity(host as unknown as AikaClawApp);
      void loadAgents(host as unknown as AikaClawApp);
      void loadHealthState(host as unknown as AikaClawApp);
      void loadNodes(host as unknown as AikaClawApp, { quiet: true });
      void loadDevices(host as unknown as AikaClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as AikaClawApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as AikaClawApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as AikaClawApp, payload);
