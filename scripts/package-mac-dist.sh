...
# Output:
# - dist/AikaClaw.app
# - dist/AikaClaw-<version>.zip
# - dist/AikaClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.aikaclaw.mac}"
...
APP="$ROOT_DIR/dist/AikaClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/AikaClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/AikaClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AikaClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AikaClaw-$VERSION.dSYM.zip"
