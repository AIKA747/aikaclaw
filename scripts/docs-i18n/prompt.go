...
- Keep product names in English: AikaClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AikaClaw Gateway, use “Gateway 网关”.
