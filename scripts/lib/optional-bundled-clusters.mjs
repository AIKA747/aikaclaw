...
export const OPTIONAL_BUNDLED_BUILD_ENV = "AIKACLAW_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.aikaclaw?.install?.npmSpec === "string" &&
    packageJson.aikaclaw.install.npmSpec.trim().length > 0
  );
}
