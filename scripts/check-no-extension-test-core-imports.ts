...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']aikaclaw\/plugin-sdk["']/,
    hint: "Use aikaclaw/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']aikaclaw\/plugin-sdk\/test-utils["']/,
    hint: "Use aikaclaw/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']aikaclaw\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or aikaclaw/plugin-sdk/testing for public surfaces.",
  },
  {
