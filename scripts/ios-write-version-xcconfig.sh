...
- AIKACLAW_GATEWAY_VERSION = exact package.json version
- AIKACLAW_MARKETING_VERSION = short iOS/App Store version
- AIKACLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
AIKACLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
AIKACLAW_MARKETING_VERSION = ${MARKETING_VERSION}
AIKACLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
