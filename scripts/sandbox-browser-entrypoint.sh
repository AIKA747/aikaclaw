...
export DISPLAY=:1
export HOME=/tmp/aikaclaw-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${AIKACLAW_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${AIKACLAW_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${AIKACLAW_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${AIKACLAW_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${AIKACLAW_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${AIKACLAW_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${AIKACLAW_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${AIKACLAW_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${AIKACLAW_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${AIKACLAW_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${AIKACLAW_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
