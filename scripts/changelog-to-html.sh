...
if [[ -z "$version_content" ]]; then
  echo "<h2>AikaClaw $VERSION</h2>"
  echo "<p>Latest AikaClaw update.</p>"
  echo "<p><a href=\"https://github.com/aikaclaw/aikaclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
