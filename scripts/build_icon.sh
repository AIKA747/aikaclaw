...
# Defaults target the AikaClaw assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/AikaClaw/Resources/AikaClaw.icns"}
