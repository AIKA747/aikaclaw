...
ASC_KEYCHAIN_SERVICE=aikaclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.aikaclaw.client
# or
...
- The beta flow regenerates `apps/ios/AikaClaw.xcodeproj` from `apps/ios/project.yml` before archiving
