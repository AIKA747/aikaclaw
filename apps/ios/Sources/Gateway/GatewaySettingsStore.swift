...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.aikaclaw.gateway"
    private static let nodeService = "ai.aikaclaw.node"
    private static let talkService = "ai.aikaclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.aikaclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.aikaclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("aikaclaw-gateway.log")
    }
