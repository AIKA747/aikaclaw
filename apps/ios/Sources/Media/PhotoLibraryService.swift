...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AikaClawPhotosLatestParams) async throws -> AikaClawPhotosLatestPayload {
        ...
        var results: [AikaClawPhotoPayload] = []
        ...
        return AikaClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AikaClawPhotoPayload
    {
