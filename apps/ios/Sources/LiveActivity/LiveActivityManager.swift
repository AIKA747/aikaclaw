...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.aikaclaw.ios", category: "LiveActivity")
    private var currentActivity: Activity<AikaClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = AikaClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<AikaClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: AikaClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> AikaClawActivityAttributes.ContentState {
        AikaClawActivityAttributes.ContentState(
    ...
    private func idleState() -> AikaClawActivityAttributes.ContentState {
        AikaClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> AikaClawActivityAttributes.ContentState {
        AikaClawActivityAttributes.ContentState(
