...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AikaClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AikaClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: AikaClawConfigFile.loadDict(),
        ...
        AikaClawConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/aikaclaw"
        state.remoteCliPath = ""
        return state
    }
}
