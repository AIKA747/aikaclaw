...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.aikaclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".aikaclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.aikaclawCommand(
            subcommand: "gateway",
