...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.aikaclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AikaClaw windows, but below the system’s pop-up menus.
