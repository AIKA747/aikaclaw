...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.aikaclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.aikaclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AikaClawChatMessage] = messages.compactMap { item in
