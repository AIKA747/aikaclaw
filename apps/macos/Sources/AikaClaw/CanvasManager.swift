...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.aikaclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("AikaClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__aikaclaw__/a2ui/").absoluteString + "?platform=macos"
    }
