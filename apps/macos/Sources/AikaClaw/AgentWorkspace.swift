...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.aikaclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AikaClawConfigFile.defaultWorkspaceURL() }
