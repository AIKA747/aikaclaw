...
private let onboardingWizardLogger = Logger(subsystem: "ai.aikaclaw", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between AikaClawProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = AikaClawProtocol.AnyCodable
