...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .aikaclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AikaClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AikaClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let aikaclawSelectSettingsTab = Notification.Name("aikaclawSelectSettingsTab")
}
