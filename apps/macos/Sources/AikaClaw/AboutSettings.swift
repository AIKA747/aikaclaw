...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/aikaclaw/aikaclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/aikaclaw/aikaclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://aikaclaw.ai")
