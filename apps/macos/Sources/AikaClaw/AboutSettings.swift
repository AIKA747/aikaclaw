...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/AIKA747/aikaclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/AIKA747/aikaclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://github.com/AIKA747/aikaclaw")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AikaClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AikaClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AikaClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AikaClawGitCommit") as? String) ??
            "unknown"
    }
