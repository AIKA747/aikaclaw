...
/// Menu contents for the AikaClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About AikaClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "AikaClaw Not Configured"
        case .remote:
            "Remote AikaClaw Active"
        case .local:
            "AikaClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .aikaclawSelectSettingsTab, object: tab)
        }
    }
