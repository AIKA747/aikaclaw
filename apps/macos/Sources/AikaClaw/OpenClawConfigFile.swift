...
enum AikaClawConfigFile {
    private static let logger = Logger(subsystem: "ai.aikaclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        AikaClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AikaClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-aikaclaw-config-file",
            "event": "config.write",
