...
enum UIStrings {
    static let welcomeTitle = "Welcome to AikaClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "aikaclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: AikaClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g aikaclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AikaClawChatViewModel(
