...
public typealias AikaClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AikaClawPlatformImage = UIImage
#endif

public struct AikaClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct AikaClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AikaClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AikaClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AikaClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct AikaClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AikaClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AikaClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AikaClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AikaClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AikaClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AikaClawChatMessageContent].self, forKey: .content) {
...
public struct AikaClawChatHistoryPayload: Codable, Sendable {
...
public struct AikaClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AikaClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AikaClawSessionPreviewItem]
}

public struct AikaClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AikaClawSessionPreviewEntry]

    public init(ts: Int, previews: [AikaClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AikaClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AikaClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AikaClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AikaClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AikaClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AikaClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AikaClawPlatformImage?
...
public struct AikaClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
