...
public enum AikaClawChatTransportEvent: Sendable {
    case health(ok: Bool)
    case tick
    case chat(AikaClawChatEventPayload)
    case agent(AikaClawAgentEventPayload)
    case seqGap
}

public protocol AikaClawChatTransport: Sendable {
...
extension AikaClawChatTransport {
    public func setActiveSessionKey(_: String) async throws {}

    public func resetSession(sessionKey _: String) async throws {
        throw NSError(
            domain: "AikaClawChatTransport",
            code: 0,
    ...
    public func listSessions(limit _: Int?) async throws -> AikaClawChatSessionsListResponse {
        throw NSError(
            domain: "AikaClawChatTransport",
            code: 0,
    ...
    public func listModels() async throws -> [AikaClawChatModelChoice] {
        throw NSError(
            domain: "AikaClawChatTransport",
            code: 0,
