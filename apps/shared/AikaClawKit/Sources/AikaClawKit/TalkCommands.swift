...
public enum AikaClawTalkCommand: String, Codable, Sendable {
...
public struct AikaClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AikaClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
