...
public enum AikaClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct AikaClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AikaClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
