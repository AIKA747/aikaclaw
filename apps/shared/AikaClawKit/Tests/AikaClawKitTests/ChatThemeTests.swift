...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = AikaClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = AikaClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
