...
export function resolveVitestIsolation(
  ...
  const forceIsolation = env.AIKACLAW_TEST_ISOLATE === "1" || env.AIKACLAW_TEST_ISOLATE === "true";
  if (forceIsolation) {
    return true;
  }
  return env.AIKACLAW_TEST_NO_ISOLATE === "0" || env.AIKACLAW_TEST_NO_ISOLATE === "false";
}
