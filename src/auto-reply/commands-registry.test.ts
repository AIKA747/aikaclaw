...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@aikaclaw", { botUsername: "aikaclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@aikaclaw args", {
        botUsername: "aikaclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@aikaclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "aikaclaw" })).toBe(
      "/help@otherbot",
    );
  });
