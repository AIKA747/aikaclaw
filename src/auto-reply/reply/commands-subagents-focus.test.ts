...
function createMatrixThreadCommandParams(commandBody: string, cfg: AikaClawConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: AikaClawConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
