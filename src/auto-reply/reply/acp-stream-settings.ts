...
function resolveAcpStreamCoalesceIdleMs(cfg: AikaClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AikaClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AikaClawConfig): AcpProjectionSettings {
