...
function resolveMentionPatterns(cfg: AikaClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AikaClawConfig | undefined, agentId?: string): RegExp[] {
