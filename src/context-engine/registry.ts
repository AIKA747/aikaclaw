...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("aikaclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("aikaclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: AikaClawConfig): Promise<ContextEngine> {
