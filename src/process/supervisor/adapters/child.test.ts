...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.AIKACLAW_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.AIKACLAW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.AIKACLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
