...
const MCPORTER_STATE_KEY = Symbol.for("aikaclaw.mcporterState");
...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: AikaClawConfig }) {
