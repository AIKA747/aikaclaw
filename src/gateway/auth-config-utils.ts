import type { GatewayAuthConfig, AikaClawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: AikaClawConfig, password: string): AikaClawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
