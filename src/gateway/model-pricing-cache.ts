...
export function collectConfiguredModelPricingRefs(config: AikaClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: AikaClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
