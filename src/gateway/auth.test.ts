...
describe("gateway auth", () => {
  ...
  it("resolves token/password from AIKACLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          AIKACLAW_GATEWAY_TOKEN: "env-token",
          AIKACLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides AIKACLAW_GATEWAY_PASSWORD", () => {
