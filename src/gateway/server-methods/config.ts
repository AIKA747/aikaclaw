...
import type { ConfigValidationIssue, AikaClawConfig } from "../../config/types.aikaclaw.js";
import {
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: AikaClawConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, both loadConfig() and loadAikaClawPlugins() already cache
