...
export function hasAmbiguousGatewayAuthModeConfig(cfg: AikaClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: AikaClawConfig): void {
