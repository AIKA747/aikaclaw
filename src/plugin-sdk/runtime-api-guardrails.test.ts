...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/googlechat/runtime-api.ts": ['export * from "aikaclaw/plugin-sdk/googlechat";'],
  "extensions/matrix/runtime-api.ts": [
    'export * from "./src/auth-precedence.js";',
    'export * from "./helper-api.js";',
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "aikaclaw/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, AikaClawConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "aikaclaw/plugin-sdk/matrix";',
    'export { formatZonedTimestamp } from "aikaclaw/plugin-sdk/matrix";',
  ],
  "extensions/nextcloud-talk/runtime-api.ts": [
    'export * from "aikaclaw/plugin-sdk/nextcloud-talk";',
  ],
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, AikaClawConfig, AikaClawPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramNetworkConfig } from "aikaclaw/plugin-sdk/telegram";',
    'export type { TelegramApiOverride } from "./src/send.js";',
    'export type { AikaClawPluginService, AikaClawPluginServiceContext, PluginLogger } from "aikaclaw/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "aikaclaw/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "aikaclaw/plugin-sdk/acp-runtime";',
    'export { buildTokenChannelStatusSummary, clearAccountEntryFields, DEFAULT_ACCOUNT_ID, normalizeAccountId, PAIRING_APPROVED_MESSAGE, parseTelegramTopicConversation, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses, resolveTelegramPollVisibility } from "aikaclaw/plugin-sdk/telegram";',
    'export { buildChannelConfigSchema, getChatChannelMeta, jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections, TelegramConfigSchema } from "aikaclaw/plugin-sdk/telegram-core";',
