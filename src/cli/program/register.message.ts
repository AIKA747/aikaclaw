...
${formatHelpExamples([
  ['aikaclaw message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'aikaclaw message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'aikaclaw message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}
