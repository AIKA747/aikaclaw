...
${formatHelpExamples([
  ['aikaclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['aikaclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'aikaclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'aikaclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['aikaclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'aikaclaw agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['aikaclaw agents set-identity --agent main --name "AikaClaw" --emoji "🦞"', "Set name + emoji."],
  ["aikaclaw agents set-identity --agent main --avatar avatars/aikaclaw.png", "Set avatar path."],
  [
    "aikaclaw agents set-identity --workspace ~/.aikaclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "aikaclaw agents set-identity --identity-file ~/.aikaclaw/workspace/IDENTITY.md --agent main",
