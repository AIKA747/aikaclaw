    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["aikaclaw channels list", "List configured channels and auth profiles."],
          ["aikaclaw channels status --probe", "Run channel status checks and probes."],
          [
            "aikaclaw channels add --channel telegram --token <token>",
