...
import { loadConfig, writeConfigFile, type AikaClawConfig } from "../config/config.js";
...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: AikaClawConfig): boolean {
...
function resolveConfiguredAuthChannelInput(cfg: AikaClawConfig, mode: ChannelAuthMode): string {
