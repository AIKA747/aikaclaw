    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["aikaclaw directory self --channel slack", "Show the connected account identity."],
          [
            'aikaclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["aikaclaw directory groups list --channel discord", "List available groups/channels."],
          [
