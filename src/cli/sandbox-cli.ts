...
const SANDBOX_EXAMPLES = {
  main: [
    ["aikaclaw sandbox list", "List all sandbox containers."],
    ["aikaclaw sandbox list --browser", "List only browser containers."],
    ["aikaclaw sandbox recreate --all", "Recreate all containers."],
    ["aikaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["aikaclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["aikaclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["aikaclaw sandbox list", "List all sandbox containers."],
    ["aikaclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["aikaclaw sandbox recreate --all", "Recreate all containers."],
    ["aikaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["aikaclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["aikaclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["aikaclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["aikaclaw sandbox explain", "Show effective sandbox config."],
    ["aikaclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["aikaclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["aikaclaw sandbox explain --json", "JSON output."],
  ],
} as const;
