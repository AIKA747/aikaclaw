...
export function listAuthProfileStorePaths(config: AikaClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: AikaClawConfig, stateDir: string): string[] {
