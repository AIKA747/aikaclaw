...
function resolveResolutionLimits(config: AikaClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: AikaClawConfig): SecretProviderConfig {
