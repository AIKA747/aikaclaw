...
let originalAikaClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalAikaClawTestConsole = process.env.AIKACLAW_TEST_CONSOLE;
  process.env.AIKACLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalAikaClawTestConsole === undefined) {
    delete process.env.AIKACLAW_TEST_CONSOLE;
  } else {
    process.env.AIKACLAW_TEST_CONSOLE = originalAikaClawTestConsole;
  }
