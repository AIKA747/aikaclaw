...
export function isAcpEnabledByPolicy(cfg: AikaClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AikaClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AikaClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AikaClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AikaClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: AikaClawConfig, agentId: string): boolean {
