...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("aikaclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "aikaclaw");
