...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AikaClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AikaClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: AikaClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
