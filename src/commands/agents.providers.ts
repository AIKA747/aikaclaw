...
function resolveDefaultAccountId(cfg: AikaClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AikaClawConfig): boolean {
...
export function summarizeBindings(cfg: AikaClawConfig, bindings: AgentBinding[]): string[] {
