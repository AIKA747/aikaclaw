...
export function collectMissingDefaultAccountBindingWarnings(cfg: AikaClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: AikaClawConfig): string[] {
  const warnings: string[] = [];
