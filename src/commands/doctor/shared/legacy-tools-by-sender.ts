...
export function scanLegacyToolsBySenderKeys(cfg: AikaClawConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: AikaClawConfig): {
