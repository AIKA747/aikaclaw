...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set AIKACLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `aikaclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control AikaClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
