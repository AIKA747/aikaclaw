...
export function listBindings(cfg: AikaClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: AikaClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AikaClawConfig) {
