...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.aikaclaw.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.aikaclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", AIKACLAW_PROFILE: "default" },
    });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when AIKACLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.aikaclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when AIKACLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", AIKACLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.aikaclaw.jbphoenix.plist",
    },
    {
      name: "prefers AIKACLAW_LAUNCHD_LABEL over AIKACLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        AIKACLAW_PROFILE: "jbphoenix",
        AIKACLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from AIKACLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        AIKACLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty AIKACLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        AIKACLAW_PROFILE: "myprofile",
        AIKACLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.aikaclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
