...
describe("provider discovery contract", () => {
  beforeEach(async () => {
    vi.resetModules();
    vi.doMock("aikaclaw/plugin-sdk/agent-runtime", async () => {
    ...
    vi.doMock("aikaclaw/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<object>("aikaclaw/plugin-sdk/provider-auth");
      return {
        ...actual,
        ensureAuthProfileStore: ensureAuthProfileStoreMock,
        listProfilesForProvider: listProfilesForProviderMock,
    ...
    vi.doMock("aikaclaw/plugin-sdk/provider-setup", async () => {
      const actual = await vi.importActual<object>("aikaclaw/plugin-sdk/provider-setup");
      return {
        ...actual,
    ...
    vi.doMock("aikaclaw/plugin-sdk/self-hosted-provider-setup", async () => {
      const actual = await vi.importActual<object>(
        "aikaclaw/plugin-sdk/self-hosted-provider-setup",
      );
      return {
        ...actual,
        buildVllmProvider: (...args: unknown[]) => buildVllmProviderMock(...args),
    ...
    vi.doMock("aikaclaw/plugin-sdk/ollama-setup", async () => {
      const actual = await vi.importActual<object>("aikaclaw/plugin-sdk/ollama-setup");
      return {
        ...actual,
        buildOllamaProvider: (...args: unknown[]) => buildOllamaProviderMock(...args),
      };
