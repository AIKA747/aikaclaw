...
type LoginOpenAICodexOAuth =
  (typeof import("aikaclaw/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("aikaclaw/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("aikaclaw/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("aikaclaw/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("aikaclaw/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("aikaclaw/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("aikaclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
