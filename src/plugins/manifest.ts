...
export const PLUGIN_MANIFEST_FILENAME = "aikaclaw.plugin.json";
...
// package.json "aikaclaw" metadata (used for setup/catalog)
...
export type AikaClawPackageStartup = {
  /**
...
export type AikaClawPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: AikaClawPackageStartup;
};
...
): AikaClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
