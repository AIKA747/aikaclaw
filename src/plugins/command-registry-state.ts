...
import type { AikaClawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = AikaClawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("aikaclaw.pluginCommandsState");
