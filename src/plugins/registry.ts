...
import type {
  ...
  AikaClawPluginApi,
  AikaClawPluginChannelRegistration,
  AikaClawPluginCliRegistrar,
  AikaClawPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  AikaClawPluginHttpRouteAuth,
  AikaClawPluginHttpRouteMatch,
  AikaClawPluginHttpRouteHandler,
  AikaClawPluginHttpRouteParams,
  AikaClawPluginHookOptions,
  MediaUnderstandingProviderPlugin,
  ProviderPlugin,
  AikaClawPluginService,
  AikaClawPluginToolContext,
  AikaClawPluginToolFactory,
  PluginConfigUiHint,
  PluginDiagnostic,
  PluginBundleFormat,
  PluginFormat,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: AikaClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: AikaClawPluginCliRegistrar;
  commands: string[];
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: AikaClawPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: AikaClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: AikaClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: AikaClawPluginHookOptions | undefined,
    config: AikaClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: AikaClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: AikaClawPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as AikaClawPluginChannelRegistration).plugin === "object"
        ? (registration as AikaClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: AikaClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: AikaClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: AikaClawPluginCommandDefinition) => {
