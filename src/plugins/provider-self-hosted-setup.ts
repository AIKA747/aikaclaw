...
export function applyProviderDefaultModel(cfg: AikaClawConfig, modelRef: string): AikaClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: AikaClawConfig; modelId: string; modelRef: string; profileId: string } {
