...
export function applyGoogleGeminiModelDefault(cfg: AikaClawConfig): {
  next: AikaClawConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: AikaClawConfig): AikaClawConfig {
...
export function applyOpenAIConfig(cfg: AikaClawConfig): AikaClawConfig {
...
export function applyOpencodeGoModelDefault(cfg: AikaClawConfig): {
  next: AikaClawConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: AikaClawConfig): {
  next: AikaClawConfig;
  changed: boolean;
} {
