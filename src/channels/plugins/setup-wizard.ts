...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: AikaClawConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: AikaClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: AikaClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: AikaClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: AikaClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: AikaClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: AikaClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: AikaClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: AikaClawConfig;
    accountId: string;
