...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: AikaClawConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: AikaClawConfig }>(
  collector: WarningCollector<{ cfg: AikaClawConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: AikaClawConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: AikaClawConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: AikaClawConfig },
>(
  projectCfg: (cfg: AikaClawConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: AikaClawConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: AikaClawConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: AikaClawConfig },
>(params: {
  providerConfigPresent: (cfg: AikaClawConfig) => boolean;
