...
export function listChannelMessageActions(cfg: AikaClawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: AikaClawConfig): ChannelMessageCapability[] {
