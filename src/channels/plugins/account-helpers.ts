...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: AikaClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: AikaClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AikaClawConfig): string {
