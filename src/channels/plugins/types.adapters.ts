...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: AikaClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: AikaClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: AikaClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: AikaClawConfig;
    accountId: string;
    enabled: boolean;
  }) => AikaClawConfig;
  deleteAccount?: (params: { cfg: AikaClawConfig; accountId: string }) => AikaClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: AikaClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: AikaClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: AikaClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: AikaClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: AikaClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.aikaclaw.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: AikaClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: AikaClawConfig;
    nextCfg: AikaClawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: AikaClawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: AikaClawConfig; accountId?: string | null }) =>
    | {
