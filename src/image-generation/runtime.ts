...
function buildNoImageGenerationModelConfiguredMessage(cfg: AikaClawConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: AikaClawConfig }) {
