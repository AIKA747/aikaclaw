...
export const A2UI_PATH = "/__aikaclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__aikaclaw__/canvas";

export const CANVAS_WS_PATH = "/__aikaclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.aikaclawCanvasA2UIAction.postMessage(...)
  // - Android: window.aikaclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["aikaclawCanvasA2UIAction"];
  ...
  globalThis.AikaClaw = globalThis.AikaClaw ?? {};
  globalThis.AikaClaw.postMessage = postToNode;
  globalThis.AikaClaw.sendUserAction = sendUserAction;
  globalThis.aikaclawPostMessage = postToNode;
  globalThis.aikaclawSendUserAction = sendUserAction;
