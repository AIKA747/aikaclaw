  ...
  return withEnvAsync(
    {
      ...
      AIKACLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when AIKACLAW_VERSION is not set", async () => {
  ...
  it("prefers AIKACLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over AIKACLAW_SERVICE_VERSION when AIKACLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        AIKACLAW_VERSION: " ",
        AIKACLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when AIKACLAW_VERSION and AIKACLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        AIKACLAW_VERSION: " ",
        AIKACLAW_SERVICE_VERSION: "\t",
