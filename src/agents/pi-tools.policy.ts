...
export function resolveSubagentToolPolicy(cfg?: AikaClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: AikaClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: AikaClawConfig["tools"];
