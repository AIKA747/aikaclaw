...
const CLEANUP_STATE_KEY = Symbol.for("aikaclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("aikaclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("aikaclaw.sessionWriteLockWatchdogState");
