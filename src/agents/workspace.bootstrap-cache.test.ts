...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("aikaclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("aikaclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("aikaclaw-cache-test2-");
