...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/aikaclaw-sandbox",
    agentWorkspaceDir: "/tmp/aikaclaw-workspace",
    workspaceAccess: "none",
    runtimeId: "aikaclaw-sbx-test",
    runtimeLabel: "aikaclaw-sbx-test",
    containerName: "aikaclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "aikaclaw-sbx-browser-test",
    },
