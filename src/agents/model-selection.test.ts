...
function resolveAnthropicOpusThinking(cfg: AikaClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<AikaClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<AikaClawConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<AikaClawConfig> = {
        agents: {
          defaults: {
            models: {
