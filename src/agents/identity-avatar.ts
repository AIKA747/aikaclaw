...
function resolveAvatarSource(cfg: AikaClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AikaClawConfig, agentId: string): AgentAvatarResolution {
