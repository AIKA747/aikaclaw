...
export const createAikaClawCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createAikaClawCodingToolsMock.mockReset();
  createAikaClawCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureAikaClawModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveAikaClawDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createAikaClawCodingTools: createAikaClawCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveAikaClawAgentDir: vi.fn(() => "/tmp"),
  }));
