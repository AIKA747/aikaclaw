...
function resolvePostCompactionIndexSyncMode(config?: AikaClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureAikaClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createAikaClawCodingTools({
      exec: {
