...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<AikaClawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<AikaClawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: AikaClawConfig): WebSearchConfig {
