...
function resolveMemoryToolContext(options: { config?: AikaClawConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: AikaClawConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: AikaClawConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: AikaClawConfig): MemoryCitationsMode {
