...
function resolveWatchPaths(workspaceDir: string, config?: AikaClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AikaClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AikaClawConfig }) {
