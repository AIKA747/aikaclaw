...
async function resolveContext(config: AikaClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AikaClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
