...
export function isCliProvider(provider: string, cfg?: AikaClawConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: AikaClawConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: AikaClawConfig }): ModelCatalogEntry[] {
