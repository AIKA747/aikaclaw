...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "aikaclaw-sbx-test",
    runtimeLabel: params.containerName ?? "aikaclaw-sbx-test",
    containerName: params.containerName ?? "aikaclaw-sbx-test",
