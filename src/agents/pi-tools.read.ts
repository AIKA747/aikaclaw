...
function resolveAdaptiveReadMaxBytes(options?: AikaClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAikaClawReadTool(base, {
...
export function createAikaClawReadTool(
  base: AnyAgentTool,
  options?: AikaClawReadToolOptions,
): AnyAgentTool {
