...
const AIKACLAW_ATTRIBUTION_PRODUCT = "AikaClaw";
const AIKACLAW_ATTRIBUTION_ORIGINATOR = "aikaclaw";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: AIKACLAW_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: AIKACLAW_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${AIKACLAW_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
