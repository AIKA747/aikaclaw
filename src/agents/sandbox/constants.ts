...
export const DEFAULT_SANDBOX_IMAGE = "aikaclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "aikaclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "aikaclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "aikaclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "aikaclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "aikaclaw-sandbox-browser";
