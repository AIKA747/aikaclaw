...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveAikaClawAgentDir() returns mainAgentDir
    process.env.AIKACLAW_STATE_DIR = tmpDir;
    process.env.AIKACLAW_AGENT_DIR = mainAgentDir;
