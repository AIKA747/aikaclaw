...
AikaClaw has three related (but different) controls:
...
Use the inspector to see what AikaClaw is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:aikaclaw`: all built-in AikaClaw tools (excludes provider plugins)
