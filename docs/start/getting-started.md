---
summary: "Get AikaClaw installed and run your first chat in minutes."
read_when:
...
Install AikaClaw, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run AikaClaw as a service account or want custom paths:

- `AIKACLAW_HOME` — home directory for internal path resolution
- `AIKACLAW_STATE_DIR` — override the state directory
- `AIKACLAW_CONFIG_PATH` — override the config file path
