---
summary: "First-run setup flow for AikaClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give AikaClaw">
...
<Step title="CLI">
  ...
  The app can install the global `aikaclaw` CLI via npm/pnpm so terminal
