---
summary: "Overview of AikaClaw onboarding options and flows"
read_when:
...
AikaClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `aikaclaw onboard`                     | Launch the app            |
...
CLI command docs: [`aikaclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the AikaClaw app. The first-run wizard walks you through the same steps
