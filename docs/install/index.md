---
summary: "Install AikaClaw — installer script, npm/pnpm, from source, Docker, and more"
read_when:
...
The fastest way to install. It detects your OS, installs Node if needed, installs AikaClaw, and launches onboarding.
...
Or skip the link and use `pnpm aikaclaw ...` from inside the repo. See [Setup](/start/setup) for full development workflows.
...
```bash
aikaclaw --version      # confirm the CLI is available
aikaclaw doctor         # check for config issues
aikaclaw gateway status # verify the Gateway is running
```

## Hosting and deployment

Deploy AikaClaw on a cloud server or VPS:
...
<CardGroup cols={3}>
  ...
  <Card title="Uninstall" href="/install/uninstall" icon="trash-2">
    Remove AikaClaw completely.
  </Card>
</CardGroup>

## Troubleshooting: `aikaclaw` not found

If the install succeeded but `aikaclaw` is not found in your terminal:
