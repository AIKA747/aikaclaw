...
<Steps>
  <Step title="Build the image">
    ...
    [GitHub Container Registry](https://github.com/AIKA747/aikaclaw/pkgs/container/aikaclaw).
...
See the [`ClawDock` Helper README](https://github.com/AIKA747/aikaclaw/blob/main/scripts/shell-helpers/README.md).
...
<AccordionGroup>
  <Accordion title="Image missing or sandbox container not starting">
    ...
    [`scripts/sandbox-setup.sh`](https://github.com/AIKA747/aikaclaw/blob/main/scripts/sandbox-setup.sh)
