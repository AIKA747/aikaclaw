---
summary: "Host AikaClaw on a DigitalOcean Droplet"
read_when:
  - Setting up AikaClaw on DigitalOcean
  - Looking for a simple paid VPS for AikaClaw
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent AikaClaw Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `aikaclaw doctor --non-interactive` and check logs with `journalctl --user -u aikaclaw-gateway.service -n 50`.
