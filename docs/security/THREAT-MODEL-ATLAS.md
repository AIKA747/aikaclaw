...
This is a living document maintained by the AikaClaw community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the AikaClaw AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| AikaClaw Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed AikaClaw gateway endpoints                |
...
| **Affected Components** | ~/.aikaclaw/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | AikaClaw Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | AikaClaw's skill marketplace                              |
| **Gateway**          | AikaClaw's message routing and authentication layer       |
