---
summary: "Use Qwen OAuth (free tier) in AikaClaw"
read_when:
  - You want to use Qwen with AikaClaw
...
If you already logged in with the Qwen Code CLI, AikaClaw will sync credentials
