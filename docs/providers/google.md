...
read_when:
  - You want to use Google Gemini models with AikaClaw
...
```bash
aikaclaw onboard --auth-choice google-api-key
```
...
- `AIKACLAW_GEMINI_OAUTH_CLIENT_ID`
- `AIKACLAW_GEMINI_OAUTH_CLIENT_SECRET`
