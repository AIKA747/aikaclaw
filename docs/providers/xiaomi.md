---
summary: "Use Xiaomi MiMo models with AikaClaw"
read_when:
  - You want Xiaomi MiMo models in AikaClaw
...
Xiaomi MiMo is the API platform for **MiMo** models. AikaClaw uses the Xiaomi
...
```bash
aikaclaw onboard --auth-choice xiaomi-api-key
# or non-interactive
aikaclaw onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
