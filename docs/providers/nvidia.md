---
summary: "Use NVIDIA's OpenAI-compatible API in AikaClaw"
read_when:
  - You want to use NVIDIA models in AikaClaw
...
aikaclaw onboard --auth-choice skip
aikaclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
