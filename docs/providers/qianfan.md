---
summary: "Use Qianfan's unified API to access many models in AikaClaw"
read_when:
...
3. AikaClaw installed on your system
...
4. Copy the API key for use with AikaClaw

## CLI setup

```bash
aikaclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AikaClaw Configuration](/gateway/configuration)
