...
You can point AikaClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AikaClaw
...
- [Anthropic provider](/providers/anthropic) - Native AikaClaw integration with Claude setup-token or API keys
