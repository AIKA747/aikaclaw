---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in AikaClaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in AikaClaw
---
...
```bash
aikaclaw onboard --kilocode-api-key <key>
```
...
AikaClaw dynamically discovers available models from the Kilo Gateway at startup. Use
