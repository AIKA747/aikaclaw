...
- [快速开始与首次运行设置](#quick-start-and-firstrun-setup)
  ...
  - [无法访问文档站点（SSL 错误），怎么办？](#i-cant-access-docsaikaclawai-ssl-error-what-now)
...
https://github.com/AIKA747/aikaclaw/issues
https://github.com/AIKA747/aikaclaw/pulls
...
查看 GitHub 变更日志：
https://github.com/AIKA747/aikaclaw/blob/main/CHANGELOG.md

最新条目在顶部。如果顶部部分标记为 **Unreleased**，则下一个带日期的部分是最新发布版本。条目按**亮点**、**变更**和**修复**分组（需要时还有文档/其他部分）。

### 无法访问文档站点（SSL 错误），怎么办

一些 Comcast/Xfinity 连接通过 Xfinity Advanced Security 错误地拦截了文档站点。禁用该功能或将文档域名加入白名单，然后重试。更多详情：[故障排除](/help/troubleshooting#docsaikaclawai-shows-an-ssl-error-comcastxfinity)。
请帮助我们在此处报告以解除封锁：https://spa.xfinity.com/check_url_status。

如果仍然无法访问该网站，文档在 GitHub 上有镜像：
https://github.com/AIKA747/aikaclaw/tree/main/docs
...
仍然卡住？在 [Discord](https://discord.com/invite/clawd) 中提问或发起 [GitHub 讨论](https://github.com/AIKA747/aikaclaw/discussions)。
