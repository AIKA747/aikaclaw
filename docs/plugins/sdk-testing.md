...
summary: "Testing utilities and patterns for AikaClaw plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for AikaClaw
plugins.
...
**Import:** `aikaclaw/plugin-sdk/testing`
...
} from "aikaclaw/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "aikaclaw/plugin-sdk/testing";
...
import type { PluginRuntime } from "aikaclaw/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `aikaclaw/plugin-sdk` root barrel is rejected
...
AikaClaw uses Vitest with V8 coverage thresholds. For plugin tests:
