...
It also covers the layered failure pattern from [issue #39369](https://github.com/AIKA747/aikaclaw/issues/39369): several independent problems can show up at once, which makes the wrong layer look broken first.
