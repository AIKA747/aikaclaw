---
summary: "Contributor guide for adding a new shared capability to the AikaClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for AikaClaw core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when AikaClaw needs a new domain such as image generation, video
