...
- Install via CLI: `aikaclaw plugins install @aikaclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `aikaclaw plugins install ./extensions/zalo`
   - From npm (if published): `aikaclaw plugins install @aikaclaw/zalo`
...
This page reflects current AikaClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `aikaclaw pairing list zalo`
  - `aikaclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in AikaClaw.
...
- Example: `aikaclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `aikaclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `aikaclaw logs --follow`
