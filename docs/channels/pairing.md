...
read_when:
  ...
  - Reviewing AikaClaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is AikaClaw’s explicit **owner approval** step.
...
Stored under `~/.aikaclaw/credentials/`:
...
3. On your phone, open the AikaClaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `aikaclaw nodes pending/approve`) is a
