---
summary: "Messaging platforms AikaClaw can connect to"
read_when:
  - You want to choose a chat channel for AikaClaw
...
AikaClaw can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and AikaClaw will route per chat.
